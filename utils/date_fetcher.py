...
class DataFetcher(object):
    ...
    def __init__(self, data, raw_ts, cpt, t=48):
    ...
    def fetch_data(self):
        ...
        """
        lc = self.cpt[0] # len_close
        lp = self.cpt[1] # len_period
        lt = self.cpt[2] # len_trend
        fp = 0 # pad_forward_period
        bp = 0 # pad_back_period
        ft = 0 # pad_forward_trend
        bt = 0 # pad_back_trend
        ip = 1 # interval_period
        it = 7 # interval_trend
        print('  DataFetcher:',
